...
export const zhCN = {
  ...
  fieldServerNameHint:
    "工具将以 mcp__<服务器名>__<工具名> 注册，1–32 位字母 / 数字 / _ / -",
  fieldTransport: "传输方式",
  fieldCommand: "命令",
  fieldArgs: "参数（每行一个）",
  fieldEnv: "环境变量",
  ...
  formMode: "表单模式",
  yamlPlaceholder:
    "粘贴或编辑该服务器的 config YAML（如 command / args / env …）",
  saveButton: "保存",
  saving: "保存中…",
  cancelButton: "取消",
  ...
  testHint:
    "保存前可先测试：宿主会真实拉起 / 连接该服务器并拉取工具清单，随后立即关闭。",
  savingError: "保存失败",
  ...
  marketDeleteSourceHint: "删除数据源 {name} 不影响已安装服务器。",
...
export const enUS: Record<keyof typeof zhCN, string> = {
  tab: "MCP servers",
  intro:
    "Manage MCP servers end to end: add, edit, enable or disable, test connections and inspect tools.",
  ...
  toolNone:
    'No tool data yet; enabled servers are probed automatically, or use "Test connection".',
  ...
  fieldServerNameHint:
    "Tools register as mcp__<server>__<tool>; 1–32 chars of letters / digits / _ / -",
  ...
  formMode: "Form mode",
  yamlPlaceholder:
    "Paste or edit this server’s config YAML (command / args / env …)",
  saveButton: "Save",
  saving: "Saving…",
  cancelButton: "Cancel",
  savedHint:
    "Written to the patch layer; Cordis HMR applies it automatically (status refreshes shortly).",
  testRunning: "Testing…",
  ...
  testHint:
    "Test before saving: the host actually launches / connects to the server, lists its tools, then shuts it down.",
  ...
  marketDeleteSourceHint: "Deleting the source {name} does not affect installed servers.",
