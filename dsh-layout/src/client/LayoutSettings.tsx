...
function Field({ icon, label, path, children }: { icon: React.ReactNode; label: string; path?: string; children: React.ReactNode }): React.ReactElement {
...
function GlobalCard({ store, settings }: { store: LayoutStore; settings: LayoutSettings }): React.ReactElement {
  ...
  return <section className="dsh-layout-settings__card">
    ...
    <Field icon={<ScrollbarIcon />} label="滚动条" path="global.scrollbar">
...
function MaterialCard({ store, settings }: { store: LayoutStore; settings: LayoutSettings }): React.ReactElement {
  ...
  return <section className="dsh-layout-settings__card">
    ...
    <Field icon={<GlassIcon />} label="磨砂材质" path="material.enabled">
    ...
    {material.enabled && <>
      ...
      <Field icon={<GlassIcon />} label="不透明度" path="material.opacity">
      ...
      <Field icon={<FluidIcon />} label="模糊强度" path="material.blur">
      ...
      <Field icon={<FluidIcon />} label="饱和度" path="material.saturation">
...
function ConversationCard({ store, settings }: { store: LayoutStore; settings: LayoutSettings }): React.ReactElement {
  ...
  return <section className="dsh-layout-settings__card">
    ...
    <Group label="排版" />
    <Field icon={<WidthIcon />} label="阅读宽度" path="conversation.width">
      <div className="dsh-layout-segmented">
    ...
    <Field icon={<RowsIcon />} label="输入框行数" path="conversation.inputRows">
      <div className="dsh-layout-segmented">
    ...
    <Field icon={<RangeIcon />} label="对话收笔" path="conversation.scrollEnd">
      <div className="dsh-layout-segmented">
    ...
    <Group label="气泡与轨迹页" />
    <Field icon={<BubbleIcon />} label="对话气泡" path="conversation.bubble">
      <div className="dsh-layout-segmented">
    ...
    <Field icon={<TraceIcon />} label="轨迹页背景" path="conversation.trace.background">
      <div className="dsh-layout-segmented">
    ...
    <Field icon={<WidthIcon />} label="轨迹页宽度" path="conversation.trace.width">
      <div className="dsh-layout-segmented">
    ...
    <Field icon={<TraceIcon />} label="轨迹表留白" path="conversation.trace.tableTail">
      <div className="dsh-layout-segmented">
    ...
    <Group label="统计" />
    <Field icon={<StatsIcon />} label="统计信息" path="conversation.stats">
      <div className="dsh-layout-segmented">
