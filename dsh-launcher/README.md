...
<p align="left">
  <img src="../docs/images/launcher/home-pc.png" width="720" alt="DSH 主页（PC）">
...
<p align="left">
  <img src="../docs/images/launcher/panel-pc.png" width="480" alt="dsh-launcher 选择面板（PC）">
  <img src="../docs/images/launcher/panel-h5.png" width="200" alt="dsh-launcher 选择面板（H5）">
  <br><em>点设置按钮后弹出的「个人插件 / 系统设置」二选一面板</em>
</p>

<p align="left">
  <img src="../docs/images/launcher/workspace-pc.png" width="720" alt="dsh-launcher 工作区（PC）">
  <br><em>桌面端 — 点"个人插件"后的全屏工作区，左栏菜单 + 右栏卡片化内容</em>
</p>

<p align="left">
  <img src="../docs/images/launcher/workspace-h5.png" width="200" alt="dsh-launcher 工作区（H5）">
