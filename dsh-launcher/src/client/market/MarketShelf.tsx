/**
 * Marketplace shelf. The shared React surface other plugins (dsh-skill-manager,
 * dsh-mcp-manager) compose into their own section. The shelf owns:
 *
 ...
 *   - The card grid
 *
 * It does NOT own the install / remove button behavior — those bubbled up
 * as `onInstall` / `onRemove` callbacks so the consumer plugin owns the
 * wire call. The card primitive is exported separately so consumers can
 * paint their own chrome around the install action if they want to.
 */
